...
export default function KpisDashboard() {
  ...
  const getAddressTypeBadge = (type: string) => {
    ...
    if (normalized.includes("orchard") && normalized.includes("sapling"))
      return "bg-gradient-to-r from-emerald-500 to-[#3B82F6] text-white";
    if (normalized.includes("orchard"))
      return "bg-gradient-to-r from-emerald-500 to-green-600 text-white";
    if (normalized.includes("sapling"))
      return "bg-gradient-to-r from-[#3B82F6] to-[#6366F1] text-white";
  ...
  return (
    <ProtectedRoute>
      <div className="max-w-7xl mx-auto px-6 py-8 bg-[#0F172A] min-h-screen text-white">
        {/* Header */}
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-400 mt-1">Key metrics and leaderboards</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          {[
            ...
            <Card key={i} className="bg-[#1E293B] border-none">
        ...
        <Card className="bg-[#1E293B] border-none mb-8">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="w-[170px] flex justify-end">
                {isAdmin && viewMode === "admin" && (
                  ...
                  >
                    {showAllUsers ? "Show Top Contributors" : "Show All Users"}
                  </Button>
                )}
              </div>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-[#334155] hover:bg-transparent">
                    ...
                    {viewMode === "admin" && (
                      <TableHead
                        className="cursor-pointer select-none text-right hover:text-white"
                ...
                <TableBody>
                  {sortedContributors.length === 0 ? (
                    ...
                    sortedContributors.map((user, index) => {
                      const rate =
                        user.submitted > 0
                          ? Math.round((user.completed / user.submitted) * 100)
                          : 0;
                      return (
                        <TableRow
                          key={index}
                          className="border-b border-[#334155] hover:bg-[#1E293B]"
                        >
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <select
                  ...
                  className="bg-[#0F172A] border border-slate-600 text-white rounded px-3 py-1 text-sm"
                >
          ...
          <Card className="bg-[#1E293B] border-none">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <Zap className="w-5 h-5 text-[#3B82F6]" /> Wallet &amp; Node
              </CardTitle>
            </CardHeader>
